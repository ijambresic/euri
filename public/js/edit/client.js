...
function handleIssueForm(coinId, name, price, amount) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch("/addIssue", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
...
function handleEditIssue(issueId, name, price, amount) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch("/editIssue", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
...
document.addEventListener("DOMContentLoaded", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    function attachEditIssueListeners(item) {
        item.addEventListener("click", function () {
            ...
            form.addEventListener("submit", function (event) {
                ...
                handleEditIssue(issueId, updatedIssue.name, updatedIssue.price, updatedIssue.amount).then(() => {
                    ...
                    const updatedItem = createIssueListItem(issueId, updatedIssue.name, updatedIssue.price, updatedIssue.amount);
        ...
        button.addEventListener("click", function () {
            ...
            form.addEventListener("submit", function (event) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const newId = yield handleIssueForm(coinId, issueName, price, amount);
    ...
    form.addEventListener("submit", function (event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield handleCoinForm(countryId, yearId, name, src, dialog);
        });
    });
